        ...
        <div class="container">
            ...
            <form action="{{url('/meetings')}}" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="text" name="topic" placeholder="Enter title" id="name" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="text" name="agenda" placeholder="Enter title" id="name" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="text" name="start_time" placeholder="ex: 2020-07-31T13:00:00" id="name" required>
                </div>
              </div>

              <div class="row">
                <input type="submit" style="background-color:blue" value="Create Meeting">
            </div>
            </form>
          </div>
