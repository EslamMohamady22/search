        ...
        @endif
            <form action="{{url('/addnewuser')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="number" name="phone" placeholder="Phone" id="name" required>
                </div>
              </div>
              <div class="row">
                <div class="col-25">
                ...
                <div class="col-75">
                    <input type="text" name="address" placeholder="Phone" id="name" required>
                </div>
              </div>
              <div class="row">
                <div class="col-25">
                  <label for="fname">Hour Price</label>
                </div>
                <div class="col-75">
                    <input type="number" name="price" placeholder="Hour Price" id="name" required>
                </div>
              </div>
              <div class="row">
                <div class="col-25">
                ...
                <div class="col-75">
                    <input type="text" name="job" placeholder="job title" id="name" required>
                </div>
              </div>
              <div class="row">
                <div class="col-25">
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="password" name="password_confirmation" placeholder="confirm password" id="password_confirmation" required autocomplete="new-password" >
                </div>
              </div>
              <div class="row">
                <div class="col-25">
                  <label for="fname">Enter CV</label>
                </div>
                <div class="col-75">
                    <input type="file" name="cv"  id="name" required>
                </div>
              </div>
              <div class="row">
